...
export const metadata: Metadata = {
  title: 'CareConnect AI Blog — Healthcare Marketing Tips & Insights',
  description: 'Practical advice for growing your healthcare practice online. Expert articles on AI, SEO, reputation management, and practice growth.',
  keywords: 'healthcare marketing blog, medical practice growth, AI for healthcare, practice SEO tips',
};
      ...
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-md">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-6 md:flex">
            <Link href="/blog" className="text-sm font-medium text-primary-600">Blog</Link>
